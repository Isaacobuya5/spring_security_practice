...
public class AccountRepositoryImpl implements AccountRepository{
    ...
    public Account create(Account account) {
        ...
        template.update("INSERT INTO accounts (username, password, email, firstname, lastname) VALUES " + "(?,?,?,?,?)", account.getUsername(),
                account.getPassword(),
                account.getEmail(),
    ...
    public void saveToken(VerificationToken verificationToken) {
        JdbcTemplate template = new JdbcTemplate(dataSource);
        template.update("INSERT INTO verification_tokens (username, token, expiry_date) VALUES " + "(?,?,?)", verificationToken.getUsername(),
    ...
    public VerificationToken findByToken(String token) {
        ...
        VerificationToken verificationToken =
                template.queryForObject("SELECT username, token, expiry_date FROM verification_tokens WHERE token = ?", new RowMapper<VerificationToken>() {
                    @Override
    ...
    public Account findByUsername(String username) {
        JdbcTemplate template = new JdbcTemplate(dataSource);
        Account account =
                template.queryForObject("SELECT username, firstname, lastname, password FROM accounts WHERE username = ?", new RowMapper<Account>() {
                    @Override
    ...
    public void createUserDetails(ConferenceUserDetails userDetails) {
        JdbcTemplate template = new JdbcTemplate(dataSource);
        template.update("INSERT INTO users (username, password, enabled) VALUES  (?,?,?)", userDetails.getUsername(),
    ...
    public void createAuthorities(ConferenceUserDetails userDetails) {
        ...
        while(iterator.hasNext()) {
            template.update("INSERT INTO authorities (username, authority) VALUES  (?,?)", userDetails.getUsername(),
